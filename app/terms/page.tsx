      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        <article className="prose prose-blue max-w-none text-[#5F6368] space-y-8">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              If you have any questions about these Terms, please contact us at: <a href="mailto:support@ezfeedback.in" className="text-[#4285F4] hover:underline">support@ezfeedback.in</a>.
            </p>
          </section>
        </article>
      </main>
